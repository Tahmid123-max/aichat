(() => {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function sendMessage(text) {
      ...
      // Character limit check 300 chars max
      if (text.length > 300) {
